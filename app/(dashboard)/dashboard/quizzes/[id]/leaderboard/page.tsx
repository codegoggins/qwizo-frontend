...
const attempts: AttemptRow[] = [
  ...
  { rank: 4, name: "Taylor Kim", score: 8, total: 10, percentage: 80, timeTaken: "4m 18s", completedAt: "22 min ago" },
  { rank: 5, name: "Morgan Davis", score: 8, total: 10, percentage: 80, timeTaken: "5m 01s", completedAt: "35 min ago" },
  { rank: 6, name: "Riley Johnson", score: 7, total: 10, percentage: 70, timeTaken: "4m 55s", completedAt: "1 hour ago" },
  { rank: 7, name: "Casey Brown", score: 7, total: 10, percentage: 70, timeTaken: "5m 30s", completedAt: "1 hour ago" },
  { rank: 8, name: "Jamie Wilson", score: 6, total: 10, percentage: 60, timeTaken: "6m 12s", completedAt: "2 hours ago" },
  { rank: 9, name: "Avery Martinez", score: 6, total: 10, percentage: 60, timeTaken: "5m 48s", completedAt: "3 hours ago" },
  { rank: 10, name: "Drew Thomas", score: 5, total: 10, percentage: 50, timeTaken: "7m 02s", completedAt: "4 hours ago" },
  { rank: 11, name: "Quinn Anderson", score: 4, total: 10, percentage: 40, timeTaken: "8m 15s", completedAt: "5 hours ago" },
  { rank: 12, name: "Reese Garcia", score: 3, total: 10, percentage: 30, timeTaken: "6m 40s", completedAt: "6 hours ago" },
];
...
const columns: ColumnDef<AttemptRow, unknown>[] = [
  ...
  },
  {
    ...
    header: "Score",
    cell: ({ row }) => (
      <span className="font-semibold">{row.original.score}/{row.original.total}</span>
    ),
  },
  {
...
export default function QuizLeaderboardPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fastestTime = "3m 12s";
  const fastestPlayer = "Alex Chen";
  ...
  return (
    <div className="flex flex-col gap-8 pb-12">
        ...
        <div className="flex items-center justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-3xl font-extrabold tracking-tight">Live Leaderboard</h1>
            </div>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            <p className="text-2xl font-extrabold tracking-tight">{fastestTime}</p>
            <p className="text-[11px] text-muted-foreground">by {fastestPlayer}</p>
          </div>
        </motion.div>
      ...
      >
        <DataTable columns={columns} data={attempts} pageSize={5} />
      </motion.div>
    </div>
  );
}
