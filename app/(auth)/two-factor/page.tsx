...
export default function TwoFactorPage() {
  ...
  function onSubmit(data: TwoFactorFormData) {
    console.log(data)
  }
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col items-center gap-4 text-center">
        <div className="flex size-16 items-center justify-center border-2 border-neo-black bg-warning shadow-[4px_4px_0px_0px_#1B1B1B]">
          <RiLockLine className="size-8 text-neo-black" />
        </div>
        <div>
          <h1 className="text-3xl font-extrabold tracking-tight">Two-factor auth</h1>
